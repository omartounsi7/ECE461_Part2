...
class PackageRating(Model):
    ...
    def __init__(self, bus_factor: float=None, correctness: float=None, ramp_up: float=None, responsive_maintainer: float=None, license_score: float=None, good_pinning_practice: float=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PackageRating':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PackageRating of this PackageRating.
        """
    ...
    def bus_factor(self, bus_factor):
        ...
        if bus_factor is None:
            raise ValueError("Invalid value for `bus_factor`, must not be `None`")
    ...
    def correctness(self, correctness):
        ...
        if correctness is None:
            raise ValueError("Invalid value for `correctness`, must not be `None`")
    ...
    def ramp_up(self, ramp_up):
        ...
        """
        if ramp_up is None:
            raise ValueError("Invalid value for `ramp_up`, must not be `None`")
    ...
    def responsive_maintainer(self, responsive_maintainer):
        ...
        if responsive_maintainer is None:
            raise ValueError("Invalid value for `responsive_maintainer`, must not be `None`")
    ...
    def license_score(self, license_score):
        ...
        if license_score is None:
            raise ValueError("Invalid value for `license_score`, must not be `None`")
    ...
    def good_pinning_practice(self, good_pinning_practice):
        ...
        if good_pinning_practice is None:
            raise ValueError("Invalid value for `good_pinning_practice`, must not be `None`")
