...
class PackageHistoryEntry(Model):
    ...
    def __init__(self, user: User=None, date: datetime=None, package_metadata: PackageMetadata=None, action: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PackageHistoryEntry':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PackageHistoryEntry of this PackageHistoryEntry.
        """
    ...
    def package_metadata(self, package_metadata):
        ...
        if package_metadata is None:
            raise ValueError("Invalid value for `package_metadata`, must not be `None`")
